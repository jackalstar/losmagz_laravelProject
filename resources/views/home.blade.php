                ...
                <div class="header-section">
                    <div class="header-left">
                        <div class="brand-logo">
                            <a href="{{ url('/') }}">
                                <img src="{{asset('assets/images/icon/logo.png')}}" alt="logo" class="img-fluid blur-up lazyload">
                            </a>
                        </div>
                    </div>
                            ...
                            <li class="header-btn custom-dropdown profile-btn btn-group">
                                <a class="main-link" href="javascript:void(0)" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    ...
                                    <div class="media d-none d-sm-flex">
                                        <div class="user-img">
                                            <img src="{{asset('storage/images/user_photos/' . $avatar['avatar_name'])}}" class="img-fluid blur-up lazyload bg-img" alt="user">
                                        </div>
                                ...
                                <div class="dropdown-content">
                                    <ul class="friend-list">
                                        <li class="d-block">
                                            <div>
                                                <div class="media">
                                                    <img src="{{asset('assets/images/user-sm/5.jpg')}}" alt="user">
                                        ...
                                        <li>
                                            <a href="#">
                                                <div class="media">
                                                    <img src="{{asset('assets/images/user-sm/6.jpg')}}" alt="user">
                                                    <div class="media-body">
                                                        <div>
                                        ...
                                        <li>
                                            <a href="#">
                                                <div class="media">
                                                    <img src="{{asset('assets/images/user-sm/7.jpg')}}" alt="user">
                                                    <div class="media-body">
                                                        <div>
                                        ...
                                        <li>
                                            <a href="#">
                                                <div class="media">
                                                    <img src="{{asset('assets/images/user-sm/2.jpg')}}" alt="user">
                                                    <div class="media-body">
                                                        <div>
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                ...
                                <div class="dropdown-content">
                                    <ul class="friend-list">
                                        ...
                                        <li>
                                            <a onclick="logoutControl('{{Auth::user()->email}}'); event.preventDefault();">
                                                <div class="media">
